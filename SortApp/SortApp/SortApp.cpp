...
BEGIN_MESSAGE_MAP(CSortAppApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CSortAppApp::OnAppAbout)
...
CSortAppApp::CSortAppApp()
{
	...
	SetAppID(_T("SortApp.AppID.NoVersion"));
...
BOOL CSortAppApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CSortAppDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CSortAppView));
	if (!pDocTemplate)
		return FALSE;
